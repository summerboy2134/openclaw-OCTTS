    ...
    *,
    ...
    user_payload = {
        ...
        "analysis_instructions": [
            ...
            "若 snapshot.financial_indicators 已有最新披露期的正式财务指标，优先使用已披露口径，不要再把更早或同期间的业绩预告写成'预计同比增长 X%-Y%'。",
            "当 snapshot.earnings_express 非空时，要优先参考最新快报中的营收、净利润、ROE、EPS 同比变化，判断基本面边际改善还是走弱。",
            "若净利润同比、扣非净利润同比或快报净利润同比的绝对值达到 300% 以上，必须提示这类极端同比通常受上年低基数、亏损转盈或利润波动影响，不能把它表述成常规经营增速；优先写成'同比大幅改善/波动较大，受低基数影响'，不要孤立渲染'同比增长 1699.1%'这类句式。",
    ...
    *,
    ...
    user_payload = {
        ...
        "writing_requirements": [
            ...
            "如果正式财务指标里已经有最新披露期的净利润同比数据，优先用'已披露一季报/财报显示'而不是'预计同比增长'。",
            "如果净利润同比、扣非净利润同比或快报净利润同比绝对值超过 300%，必须补一句'受低基数、扭亏或利润波动影响，同比弹性大，不宜按常规增速线性外推'；可以写'同比大幅改善'，但不要只丢一个夸张百分比。",
