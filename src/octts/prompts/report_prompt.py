    ...
    *,
    ...
    user_payload = {
        ...
        "analysis_instructions": [
            ...
            "即使 signal 为 avoid，也应尽量给出观察性参考点位：entry_zone 表示潜在关注区间，stop_loss 表示若逆势试错时的风险边界，take_profit 表示若超预期反弹时的观察目标位；这些点位仅供观察，不代表建议参与。",
            "除非行情信息严重不足，否则不要把 entry_zone、stop_loss、take_profit 全部留空。",
